...
class segmentCombiner(timeObject):
    ...
    def __init__(self, imML:np.array, imU:np.array, acrit:int, rErode:int=5, rDilate:int=10, diag:int=0, **kwargs):
        super().__init__()
        ...
        filled = fil.filler(filled, fi.fillMode.fillTiny, acrit=50).filled
